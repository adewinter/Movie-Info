...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Movie.imbdb_url'
        db.delete_column('imdb_movie', 'imbdb_url')

        # Adding field 'Movie.imdb_url'
        db.add_column('imdb_movie', 'imdb_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Movie.imbdb_url'
        db.add_column('imdb_movie', 'imbdb_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Deleting field 'Movie.imdb_url'
        db.delete_column('imdb_movie', 'imdb_url')

        # Changing field 'Movie.year'
        db.alter_column('imdb_movie', 'year', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=3))
