...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NameWordsBlackList.parse_order'
        db.add_column('imdb_namewordsblacklist', 'parse_order', self.gf('django.db.models.fields.IntegerField')(default=9999, max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NameWordsBlackList.parse_order'
        db.delete_column('imdb_namewordsblacklist', 'parse_order')
